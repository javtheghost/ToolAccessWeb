...
@Component({
  ...
  template: `
    <div class="rounded-xl bg-white shadow p-4 flex flex-col gap-2 h-full">
      ...
      <div class="bg-red-50 rounded-lg p-4 flex flex-row items-center justify-between">
