...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ButtonModule, HistoryDamagesCrudComponent, FinesConfigCrudComponent, RecentFinesCrudComponent],
  template: `
    <div class="p-4 sm:p-6 lg:p-8">
      <div class="mb-6">
        ...
        Administra las políticas y el seguimiento de sanciones dentro del sistema. Desde esta sección podrás configurar las reglas de multas, registrar reportes de daños a herramientas y dar seguimiento a cada caso para asegurar el cumplimiento de las normativas internas.
        </p>
      </div>
